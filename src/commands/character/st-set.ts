...
export function registerStSetCommand(parent: Command, ctx: Context, diceAdapter: DiceAdapter) {
      ...
      try {
        ...
        for (const op of operations) {
          if (op.op === 'set') {
            ...
            const newValue = op.op === 'add' ? currentValue + delta : currentValue - delta;
